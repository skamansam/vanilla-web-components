...
- 🔧 Added a `pre-commit` hook to run `pnpm biome:check` before every commit, keeping code formatting and linting green.
- 📝 Added `AGENTS.md`, a project guide for LLMs with enterprise focus and agent conventions.
